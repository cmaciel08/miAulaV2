...
class SemestresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create semestre" do
    assert_difference('Semestre.count') do
      post semestres_url, params: { semestre: { nombreSemestre: @semestre.nombreSemestre } }
    end
  ...
  test "should update semestre" do
    patch semestre_url(@semestre), params: { semestre: { nombreSemestre: @semestre.nombreSemestre } }
